...
class Chart extends Events {
    ...
    appendTo(selectorOrEl) {
        ...
        var xFormat = this.xLabelFormat || xRange.tickFormat;
        this.xLabelFormat = xFormat ? d3.format(xFormat) : identityFn;

        var yFormat = this.yLabelFormat || yRange.tickFormat;
        this.yLabelFormat = yFormat ? d3.format(yFormat) : identityFn;
