...
class Chart extends Events {
    ...
    appendTo(selectorOrEl) {
        ...
        if (this.xLabelFormat && xRange.tickFormat) {
            this.xLabelFormat = d3.format(this.xLabelFormat);
        } else {
            this.xLabelFormat = identityFn;
        }
        if (this.yLabelFormat && yRange.tickFormat) {
            this.yLabelFormat = d3.format(this.yLabelFormat);
        } else {
            this.yLabelFormat = identityFn;
        }

        // add padding
        this._padAxes(xRange, yRange);

        var xAxis = this._drawXAxis(d3Svg, xRange, height, margins, this.xGrid, this.xLabelFormat);
        var yAxis = this._drawYAxis(d3Svg, yRange, width, margins, this.yGrid, this.yLabelFormat);
        ...
        aggregateDataRange.on('change', (e) => {
            var newScales = aggregateDataRange.getScales(xScreenRange, yScreenRange);
    ...
    */
    ...
    _drawXAxis(d3Svg, xRange, height, margins, showGrid, labelFormat) {
    ...
    _drawYAxis(d3Svg, yRange, width, margins, showGrid, labelFormat) {
