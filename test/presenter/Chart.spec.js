...
function (
    ...
    describe('Chart', function() {
        ...
        it('should update axis labels', function() {
            var chart = new Nugget.Chart({
                axisLabels: { x: 'x', y: 'y' }
            });
            chart.appendTo('#container');
            expect( $('.axis_label--x').text()).toBe('x');
            expect( $('.axis_label--y').text()).toBe('y');

            chart.updateAxisLabels({ x: 'foo', y: 'bar' });
            expect( $('.axis_label--x').text()).toBe('foo');
            expect( $('.axis_label--y').text()).toBe('bar');
        });
